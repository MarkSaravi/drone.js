...
void write_LCD(){                                                      //Subroutine for writing the LCD
  ...
  if(lcd_loop_counter == 3)Serial.println(abs(angle_pitch_buffer)/1000);    //Print first number
  if(lcd_loop_counter == 4)Serial.println((abs(angle_pitch_buffer)/100)%10);//Print second number
  if(lcd_loop_counter == 5)Serial.println((abs(angle_pitch_buffer)/10)%10); //Print third number
  if(lcd_loop_counter == 6)Serial.println(".");                             //Print decimal point
  if(lcd_loop_counter == 7)Serial.println(abs(angle_pitch_buffer)%10);      //Print decimal number
  ...
  if(lcd_loop_counter == 9){
    if(angle_roll_buffer < 0)Serial.println("-");                           //Print - if value is negative
    else Serial.println("+");                                               //Print + if value is negative
  }
  if(lcd_loop_counter == 10)Serial.println(abs(angle_roll_buffer)/1000);    //Print first number
  if(lcd_loop_counter == 11)Serial.println((abs(angle_roll_buffer)/100)%10);//Print second number
  if(lcd_loop_counter == 12)Serial.println((abs(angle_roll_buffer)/10)%10); //Print third number
  if(lcd_loop_counter == 13)Serial.println(".");                            //Print decimal point
